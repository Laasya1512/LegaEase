...
# Set page config
st.set_page_config(page_title="LegaEase - Simplifying Legal Matters", layout="wide")
...
with st.container():
    ...
    with col1:
        ...
        st.write("""
            At LegaEase, our journey began with the vision of simplifying legal documentation for individuals and businesses alike. 
...
with st.container():
    ...
    with st.container():
        ...
        with left:
            ...
            st.write("Name: Amogha B V ")
            st.write("Usn: 1BG21AI012")
            st.write("Email: aaa@gmail.com")
        with mid1:
            if profile_image:
                st.image(profile_image2, use_column_width=True)
            st.write("Name: Kajal S Singh")
            st.write("Usn: 1BG21AI047")
            st.write("Email: xxx@gmail.com")
        with mid2:
            if profile_image:
                st.image(profile_image3, use_column_width=True)
            st.write("Name: Karishma Chauhan")
            st.write("Usn: 1BG21AI049")
            st.write("Email: yyy@gmail.com")
        with right:
            if profile_image:
                st.image(profile_image4, use_column_width=True)
            st.write("Name: Laasya Reddy M")
            st.write("Usn: 1BG21AI059")
